...
<section class="relative py-20 bg-cream overflow-visible">
		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
			...
			<div>
				...
				<div class="flex items-start gap-3 mb-4">
					@if($c['icon'] === 'mail')
					<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" class="flex-shrink-0 mt-[2px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
				...
				<form id="artist-application-form"
					...
					<div class="mb-6">
						...
						<input type="email" id="email" name="email"
							class="input-underline" value="{{ old('email') }}"
							autocomplete="email" required>
					</div>

					{{-- Collaboration area --}}
					<div class="mb-6">
						<label for="collaboration_area" class="block text-sm font-semibold text-ev-dark mb-1">
							Во која област сакаш да соработуваш со нас?
						</label>
						<input type="text" id="collaboration_area" name="collaboration_area"
							class="input-underline" value="{{ old('collaboration_area') }}" required>
					</div>

					{{-- Message --}}
					<div class="mb-6">
						<label for="message" class="block text-sm font-semibold text-ev-dark mb-1">
							Остави кратка порака
						</label>
						<textarea id="message" name="message" rows="4"
							class="input-underline resize-y min-h-[100px]"
					...
					<div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
						<div>
							...
							<input type="tel" id="phone" name="phone"
								class="input-underline" value="{{ old('phone') }}"
								autocomplete="tel">
						</div>
						<div>
							<label for="social_media" class="block text-sm font-semibold text-ev-dark mb-1">
								Социјална мрежа
							</label>
							<input type="url" id="social_media" name="social_media"
								class="input-underline" value="{{ old('social_media') }}"
								placeholder="https://...">
						</div>
					</div>
					...
					{{-- Portfolio PDF --}}
					<div class="mb-8">
						<label for="portfolio" class="block text-sm font-semibold text-ev-dark mb-2">
							Прикачи портфолио и кратка биографија
						</label>
	...
	<div class="hidden lg:block absolute right-[0%] bottom-[0px] w-[25%] pointer-events-none z-0">
